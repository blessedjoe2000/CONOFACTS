...
function Timeline() {
  ...
  const postUser = useSelector((state) => state?.posts?.posts);

  const [userPosts, setUserPosts] = useState([]);
  const [showReadMoreModal, setShowReadMoreModal] = useState(false);
  const [readMorePost, setReadMorePost] = useState(null);
  const [joinTrip, setJoinTrip] = useState([]);
  ...
  const handleJoinTrip = () => {
    postUser.map((post) => console.log("post", post));
  };
  ...
  return (
    <>
      ...
      <div className="timeline-card">
        {userPosts &&
          userPosts.map((post) => (
            <div className="timeline-container" key={post._id}>
              <div className="timeline">
                ...
                <div className="avatar-container">
                  ...
                  />
                  <button onClick={handleJoinTrip} className="join-trip ">
                    Join Trip
                  </button>
                </div>
              </div>
